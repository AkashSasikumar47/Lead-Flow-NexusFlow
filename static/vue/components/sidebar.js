          ...
          <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
              ...
              <ul id="management-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                  <router-link v-if="['Manager'].includes(role)" to="/inquiry">
                    <i class="bi bi-circle"></i>Inquiries
                  </router-link>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
              ...
              <ul id="settings-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                  <router-link v-if="['Manager'].includes(role)" to="/general_settings">
                    <i class="bi bi-circle"></i>General Settings
                  </router-link>
                </li>
                <li>
                  <router-link v-if="['Manager'].includes(role)" to="/user_management">
                    <i class="bi bi-circle"></i>User Management
                  </router-link>
                </li>
              </ul>
            </li><!-- End Settings Nav -->
